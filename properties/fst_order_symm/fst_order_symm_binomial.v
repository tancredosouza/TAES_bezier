...
Require Import fst_order_interpolation_binomial.
...
Proof.
  intros b P0 P1 q H.
  apply (bezier_curve_fst_order_binomial b P0 P1 q) in H as H1.
  apply (bezier_curve_fst_order_binomial_rev b P0 P1 q) in H as H2.
  
  destruct (calc_bezier_binomial b q) as [ x3 y3 ].
  destruct (calc_bezier_binomial (rev b) (1 - q)) as [ x4 y4 ].
